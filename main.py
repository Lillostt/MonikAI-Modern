...
# --- LIGHTWEIGHT PAGE PLACEHOLDER ---
class APIPagePlaceholder:
    """Lightweight placeholder object for API-based page state."""
    def __init__(self):
        pass
...
def listenToClient(client):
    ...
    while True:
        ...
        if received_msg == "chatbot":
            ...
            try:
                msg = post_message(page, received_msg)
